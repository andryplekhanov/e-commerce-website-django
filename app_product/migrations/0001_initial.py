# Generated by Django 2.2 on 2023-01-17 17:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.FileField(blank=True, db_index=True, upload_to='category/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['png'], message='Ошибка загрузки: допускаются только файлы с расширением .png'), app_product.validators.product_image_size_validate], verbose_name='иконка')),
                ('image', models.ImageField(blank=True, db_index=True, upload_to='category/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['png', 'jpg', 'gif'], message='Ошибка загрузки: допускаются только файлы с расширением .jpg .gif .png'), app_product.validators.product_image_size_validate], verbose_name='изображение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to='products/%Y/%m/%d', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['png', 'jpg', 'gif'], message='Ошибка загрузки: допускаются только файлы с расширением .jpg .gif .png'), app_product.validators.product_image_size_validate], verbose_name='изображение')),
